    ...
    return <>
        ...
        <Container className={styles.content}>
            ...
            <div className={styles.right}>
                <p className={styles.subtitle}>{t(tokens.page.apply.myPhoto)}</p>
                ...
                <div className={styles.documentRow}>
                    <p><span>{t(tokens.page.apply.cvField)}</span> ({t(tokens.page.apply.cvRequirements)})</p>
                    <Input />
                </div>
                <div className={styles.documentRow}>
                    <p><span>{t(tokens.page.apply.coverLetterField)}</span> ({t(tokens.page.apply.coverLetterRequirements)})</p>
                    <Input />
                </div>
                <div className={styles.documentRow}>
                    <p><span>{t(tokens.page.apply.otherField)}</span> ({t(tokens.page.apply.otherRequirements)})</p>
                    <Input />
                </div>
            </div>
        </Container>
